/**
 * F069 — Quick Setup Wizard React entry.
 *
 * Feature 069 T025 + T026 — Mounts <WizardStateProvider><App /></WizardStateProvider>
 * at #acrossai-mcp-quick-setup-root (rendered by QuickSetupPage::render()).
 *
...
const mount = () => {
	const el = document.getElementById( 'acrossai-mcp-quick-setup-root' );
	if ( ! el ) {
		return;
	}
