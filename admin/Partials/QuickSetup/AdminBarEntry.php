<?php
/**
 * AdminBarEntry — persistent "Quick Setup for MCP" chip in the admin bar.
 *
 ...
 * @subpackage Admin/Partials/QuickSetup
 * @since      0.2.11
 */

namespace AcrossAI_MCP_Manager\Admin\Partials\QuickSetup;
...
/**
 * Registers the "Quick Setup for MCP" node on the wp-admin toolbar.
 *
 * @since 0.2.11
 */
final class AdminBarEntry {
	 ...
	 */
	private const NODE_ID = 'acrossai-mcp-quick-setup';
	...
	public function register_node( WP_Admin_Bar $wp_admin_bar ): void {
		...
		// use the wizard. Same gate as QuickSetupController::permission_check().
		...
		$wp_admin_bar->add_node(
			array(
				...
				'title' => '<span class="ab-icon dashicons dashicons-admin-tools" style="top:3px;"></span>'
					. esc_html__( 'Quick Setup for MCP', 'acrossai-mcp-manager' ),
				'href'  => esc_url( admin_url( 'admin.php?page=acrossai_mcp_manager&quick-setup=1&step=1' ) ),
				'meta'  => array(
