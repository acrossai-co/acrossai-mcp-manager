<?php
/**
 * QuickSetupPage — hijacks the plugin's admin page render when
 * ?quick-setup=1 is present.
 *
...
final class QuickSetupPage {
	...
	public function render(): void {
		...
		echo '<noscript><p>';
		echo esc_html__(
			'The Quick Setup wizard requires JavaScript. Enable JavaScript in your browser to use it.',
