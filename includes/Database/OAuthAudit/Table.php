<?php
/**
 * BerlinDB Table subclass for the OAuthAudit module.
 *
...
/**
 * Manages database table creation and upgrades for the OAuthAudit module.
 *
...
class Table extends \BerlinDB\Database\Kern\Table {
	 ...
	 * @var string
	 */
	protected $name = 'acrossai_mcp_oauth_audit';
	 ...
	 * @var string
	 */
	protected $db_version_key = 'acrossai_mcp_oauth_audit_db_version';
